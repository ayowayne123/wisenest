...
const ImpactPoints = ({ point }) => {
  return (
    <div className="pt-8 pb-11 lg:text-xl slg:text-lg flex flex-row items-center gap-8">
...
function Impact() {
  return (
    <section className="py-10 container ">
      ...
      <div className="bg-wiseNestBlueGreen w-full rounded-[30px] slg:min-h-[585px] lg:min-h-[685px] my-5 slg:pr-10 lg:pr-16 grid grid-cols-2">
        <div className="relative">
          <div className="absolute slg:h-[330px]  slg:w-[290px] lg:h-[380px] slg:top-[60px] slg:left-[20px]  lg:w-[330px] lg:top-[76px] lg:left-[56px] z-10">
          ...
          <div className="absolute lg:h-[380px]  lg:w-[330px]   slg:h-[330px]  slg:w-[290px] z-20 rotate-[30deg] slg:top-[160px] slg:left-[140px] lg:top-[203px] lg:left-[226px]">
            <div className="h-full w-full relative">
              <Image
                src={impact2}
                fill
